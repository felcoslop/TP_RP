...
% Atalho para o link de download dos pesos (OneDrive)
\newcommand{\pesoslink}{https://1drv.ms/f/c/5f1c3aa3f12af1a2/IgAXyJ8a0YxFTKGKjhWP1d7SAaFLQOYzJqZubJ9Ipjfn44Y?e=J5HokV}
...
\begin{frame}[fragile]{Documentação dos pesos pré-treinados}
    ...
    \begin{block}{Download dos pesos (não vão no repositório)}
        ...
        \href{\pesoslink}{\textbf{OneDrive --- baixar pesos}} \\[2pt]
        {\tiny\url{\pesoslink}}
    \end{block}
\end{frame}
